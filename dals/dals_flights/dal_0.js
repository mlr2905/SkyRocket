...
async function get_all() {
   ...
   const h = await connectedKnex('passengers')
   const g = await connectedKnex('chairs').select('*')
   .leftJoin('flights', 'flights.id', 'chairs.flight_id')
   .leftJoin('planes', 'planes.id', 'chairs.airplane_id')
